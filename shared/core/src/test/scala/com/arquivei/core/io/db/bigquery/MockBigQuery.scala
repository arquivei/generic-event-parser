...
class MockBigQuery extends BigQuery {
  ...
  override def getJob(jobId: String, options: BigQuery.JobOption*): Job = ???

  override def getJob(jobId: JobId, options: BigQuery.JobOption*): Job = ???
  ...
  override def query(configuration: QueryJobConfiguration, options: BigQuery.JobOption*): TableResult = ???

  override def query(configuration: QueryJobConfiguration, jobId: JobId, options: BigQuery.JobOption*): TableResult = ???
