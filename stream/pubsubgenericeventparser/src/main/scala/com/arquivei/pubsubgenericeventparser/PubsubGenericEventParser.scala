...
import com.arquivei.pubsubgenericeventparser.Coders._
import com.arquivei.pubsubgenericeventparser.StreamingInsert.{WriteToBigQuery, WriteToBigQueryAfterSchemaMutation}
import com.google.api.services.bigquery.model.TableRow
import com.google.gson.Gson
import com.spotify.scio.ScioContext
import com.spotify.scio.bigquery.{BigQuerySysProps, _}
...
class PubsubGenericEventParser(sc: ScioContext) extends StreamPipeline[SCollection[String]] {
  ...
  override def build(pubSubMessages: SCollection[String]): Unit = {
    ...
    val parsedJValue = pubSubMessages
    ...
    .withGlobalWindow().saveAsTypedBigQuery(
      {if (sc.isTest) "fallback:fallback.fallback" else genericEventParserFunctions.fallbackTableSpec},
      writeDisposition = WriteDisposition.WRITE_APPEND,
      createDisposition = CreateDisposition.CREATE_NEVER
    )
  }
